...
if not db_url:
    logger.warning("MYSQL_URL no definido. Usando SQLite local 'sqlite:///Universida.db'.")
    db_url = "sqlite:///Universida.db"
    ...
    return (
        {
            ...
            "endpoints": {
                ...
                "GET /uni": "Listado de universidades",
                "POST /uni": "Crear universidad",
                "GET /": "Información de la API",
                "GET /health": "Health check",
            },
            "repository": "https://github.com/Brayanf22/dev",
        },
        200,
    )
