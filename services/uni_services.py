...
class UniService:
    ...
    def crear_uni(self, nombre: str, codigo: str):
        return self.repository.create_uni(nombre, codigo)

    def actualizar_uni(self, uni_id: int, nombre: str = None, codigo: str = None):
        return self.repository.update_uni(uni_id, nombre, codigo)
